...
class _BuyerMarketplaceViewState extends State<BuyerMarketplaceView> {
  ...
  final List<Map<String, dynamic>> _products = [
    ...
    {
      'imageUrl': 'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
      'title': 'Fresh Vegetables',
      'price': '60',
      'description': 'Locally grown vegetables, pesticide-free and harvested daily.',
      'category': 'Vegetables',
    },
    {
      'imageUrl': 'https://images.unsplash.com/photo-1597362925123-77861d3fbac7?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
      'title': 'Organic Eggs',
      'price': '45',
                  ...
                  child: StoryCircle(
                    ...
                    onTap: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Viewing ${farmer['name']}\'s story')),
                      );
                    },
                  ),
                );
                ...
                return Padding(
                  ...
                  child: ChoiceChip(
                    ...
                    labelStyle: theme.textTheme.bodyMedium?.copyWith(
                      color: isSelected ? Colors.white : AppColors.charcoalBlack,
                ...
                Row(
                  children: [
                    IconButton(
                      icon: Icon(
                        Icons.grid_view,
                        color: _isGridView ? AppColors.tamarindBrown : AppColors.palmAshGray,
                      ),
                      onPressed: () {
                        setState(() {
                          _isGridView = true;
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return FarmCard(
                            ...
                            onTap: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(content: Text('Viewing ${product['title']}')),
                              );
                            },
                          );
                        },
